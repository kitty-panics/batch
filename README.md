...
以前写 Batch 都是需要时临时在网上搜索，然后再 C-c/C-v，最近准备用 Batch 写几个小工具，还是觉得应该系统的学习一下。
不过目前 Batch 除了系统自带的帮助文档，似乎就没有完整的教程了，遂整理了一下。

## 文档生成：

> help > temp
>
> grep -o -E "^[A-Z]*" temp > fuckme && del /q temp
>
> for /f %i in (fuckme) do cmd /c %i /? > command\%i && del /q fuckme
